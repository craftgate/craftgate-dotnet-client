...
namespace Samples
{
    public class WalletSample
    {
        ...
        public void Cancel_Withdraw()
        {
            ...
            var response = _craftgateClient.Wallet().CancelWithdraw(new CancelWithdrawRequest {WithdrawId = withdrawId});
        ...
        [Test]
        public void Create_Member_Wallet()
        {
            long memberId = 1L;
            ...
            var response = _craftgateClient.Wallet().CreateMemberWallet(memberId, createWalletRequest);
